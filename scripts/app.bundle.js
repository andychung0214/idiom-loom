...
function renderApp(root, model){root.innerHTML=(model.screen==='menu'?menu():model.screen==='complete'?results(model):game(model))+`<footer class="site-footer">文字內容由鍾狂授權使用。</footer>`}
