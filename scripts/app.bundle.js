...
const header=()=>`<header class="masthead"><button class="logo" data-action="menu" aria-label="回到首頁"><span class="kicker">IDIOM LOOM · 01</span><span class="title">字字成章</span></button><span>交錯成語填空</span></header>`;
